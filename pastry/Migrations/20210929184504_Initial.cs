        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sweets_Category_categoryID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderDetail_Sweets_SweetsID",
                        column: x => x.SweetsID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShopCartItem_Sweets_sweetid",
                        column: x => x.sweetid,
                        principalTable: "Sweets",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetail_SweetsID",
                table: "OrderDetail",
                column: "SweetsID");

            migrationBuilder.CreateIndex(
                name: "IX_ShopCartItem_sweetid",
                table: "ShopCartItem",
                column: "sweetid");
